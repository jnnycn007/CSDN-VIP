...
这个脚本我已经很久没有在维护了，现在我来说明一下：

这个脚本其实是有用的，但因为没有VIP权限，所以后端返回的内容不完整，因此这个插件最终的展示效果就是让前端被遮盖的内容渲染了出来

当然，如果实现的原理是靠后端控制的话，那GG了。

除此之外，因为才疏学浅不能对代码进一步迭代了，如果有其他感兴趣的大佬可以将代码进一步改进，那也是非常欢迎和感谢的
